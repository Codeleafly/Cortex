...
### 1. Define the Instruction (@cortex/shared)
...
### 2. Update the Frontend (@cortex/frontend)
...
### 3. Update the Runtime (@cortex/runtime)
...
### 4. Verification
- Create a new integration test in `tests/ctx/` (e.g., `test_XX_feature.ctx`).
